...
$string['overviewstep'] = 'Overview step';
$string['overviewstepdesc'] = 'The number of course overviews to get per request (a maximum of 10 allowed)';
...
$string['toomanycoursesrequested'] = 'Too many courses in request';
