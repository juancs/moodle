...
M.block_course_overview.handle_next_overview = function (id, r) {
            ...
            if (!response.error) {
                ...
                if (ainfo) {
                    ...
                    for (var module in response) {
                        ...
                        html += '<a href="' + M.cfg.wwwroot + '/mod/' + module +
                                '/index.php?id=' + M.block_course_overview.currentCourse + '">';

                        html += '<img class="iconlarge" alt="' + M.str['mod_' + module]['modulename'] + 
                                '" title="' + M.str['mod_' + module]['modulename'] + '" src="' +
                                M.block_course_overview.pixUrls[module] + '">';
